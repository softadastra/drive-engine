# 🧩 os — Example project using [Vix.cpp](https://github.com/vixcpp/vix)

os is a minimal example showcasing how to build and run a C++ web application using the **Vix.cpp** framework.
